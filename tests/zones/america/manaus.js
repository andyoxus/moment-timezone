...
exports["America/Manaus"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Manaus", { offset: true, expect: "America/Caracas" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Manaus", { abbr: true, expect: "America/Caracas" }),
