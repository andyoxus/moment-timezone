...
exports["Brazil/West"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Brazil/West", { offset: true, expect: "America/Caracas" }),

	"guess:by:abbr" : helpers.makeTestGuess("Brazil/West", { abbr: true, expect: "America/Caracas" }),
